...
import { Brain, User, Mail, Lock, ArrowRight, Layers, Search, Sparkles } from 'lucide-react'
...
const FEATURES = [
  {
    ...
    desc: 'URLs, notes, images, YouTube videos — unified in a single searchable vault.',
  },
  {
    icon: Search,
    label: 'Chat with your content',
    desc: 'Ask anything. Your AI retrieves answers from what you actually saved.',
  },
  {
    icon: Sparkles,
    label: 'Auto-categorized & tagged',
    desc: 'Every item is analyzed, labeled, and organized for you — zero effort.',
  },
]
...
export default function Signup() {
  ...
  useEffect(() => { setEmail(''); setPassword(''); setFullName(''); setError('') }, [])
    ...
    <div className={styles.container}>
      ...
      <div className={styles.left}>
        ...
        <div className={styles.leftInner}>
          ...
          >
            <div className={styles.logoMark}><Brain size={22} /></div>
            <div>
          ...
          <div className={styles.hero}>
            ...
            >
              ...
              <span className={styles.eyebrowText}>Get started</span>
            </motion.div>
            ...
            >
              Create your vault once, start saving instantly. A focused workspace built for deep thinking and fast recall.
            </motion.p>
            ...
            >
              {FEATURES.map(({ icon: Icon, label, desc }, i) => (
                ...
                >
                  <div className={styles.featureIconWrap}><Icon size={15} /></div>
                  <div>
      ...
      <div className={styles.right}>
        ...
        >
          <div className={styles.cardEyebrow}>
            ...
            <span className={styles.cardEyebrowText}>Get started</span>
          </div>

          <h2 className={styles.cardTitle}>Create your account</h2>
          <p className={styles.cardSubtitle}>Sign up below and start using NeuroVault instantly.</p>

          <button className={styles.googleBtn} onClick={handleGoogleSignup} disabled={googleLoading}>
